...
/**
 * Valida la estructura de datos del servicio: (siemrpe se pone una descripción de la función)
 * @method validarSchema
 * @param {String} schemaName - Nombre del archivo que está en la 
 * carpeta de fixtures/schemas correspondiente al archivo que posee la 
 * estructura de datos de servicio que se desea validar
 * @param {String} servicioName - Nombre del archivo que está en la carpeta 
 * de fixtures/autogenerado
 */
Cypress.Commands.add(
    "validarSchema", 
    (schemaName, servicioName) => {
      cy.fixture(`Schemas/${schemaName}.json`).then((schema) => {
        //Qué se hace con el schema? Esto:
