  ...
  { tags: '@regression' }, () => {
    ...
    it("Verificar Menú", () => {
        ...
        edenHeader
          ...
          .each((button, $index) => {
            cy.wrap(button)
            .should("contain.text", menuBtn[$index]);
        });
     });
    ...
    it("Verificar imagen del logo", () => {
        ...
        edenHeader
          .getImageLogo()
          .should("have.attr", "src", imgSource);
        edenHeader
          .getImageLogo()
          .should("have.attr", "alt", "EdenEntradas");
     });
    ...
    it("Validación del calendario", () => {
        ...
        edenHeader
          .getCalendarTitle()
          .should("contain.text", mes);
        edenHeader
          .getCalendarTitle()
          .should("contain.text", anio);
        edenHeader
          .getCalendar()
          .find("td")
        ...
        edenSalas
          ...
          .each((block) => { 
            cy.wrap(block)
             .should("be.visible");
            cy.wrap(block)
             .should("contain.text", titulosSalas[$inx]);
       });
    ...
    it("Verificar nombre de salas con FIXTURE", () => {
        ...
        //Validación de los títulos por array
         ...
         edenSalas
           .getSalaBlock()
           .eq($inx)
           .should("contain.text", sala.title);
         edenSalas
           .getSalaBlock()
           .eq($inx)
